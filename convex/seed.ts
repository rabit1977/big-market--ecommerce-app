...
const categoriesData = [
  ...
  },
  {
    ...
    template: {
      fields: [
        { key: 'adType', label: 'Ad Type', options: ['For Sale', 'For Rent'], type: 'select' },
        { key: 'commercial_type', label: 'Type', options: ['Office Space', 'Retail Shop', 'Warehouse', 'Restaurant / Café', 'Hotel / Hostel', 'Industrial Space', 'Other'], type: 'select' },
        { key: 'condition', label: 'Condition', options: ['New', 'Renovated', 'Good', 'Needs Renovation'], type: 'select' },
        { key: 'm2', label: 'Area (m2)', placeholder: 'm2', type: 'number' },
        { key: 'floor', label: 'Floor', placeholder: 'Floor (0 = ground)', type: 'number' },
        { key: 'heating', label: 'Heating', options: ['Central', 'Electricity', 'Heat Pump', 'None'], type: 'select' },
        { key: 'parking', label: 'Parking', options: ['Yes', 'No', 'Nearby'], type: 'select' },
      ],
  ...
  },
  {
    ...
    template: {
      fields: [
        { key: 'condition', label: 'Condition', options: ['New (Sealed)', 'New (Open Box)', 'Like New', 'Used', 'For Parts'], type: 'select' },
        { key: 'brand', label: 'Brand', options: ['Apple', 'Samsung', 'Lenovo', 'Huawei', 'Xiaomi', 'Amazon Kindle', 'Microsoft Surface', 'Other'], type: 'select' },
        { key: 'model', label: 'Model', placeholder: 'e.g. iPad Air 5, Galaxy Tab S9', type: 'text' },
        { key: 'storage_gb', label: 'Storage (GB)', options: ['16', '32', '64', '128', '256', '512'], type: 'select' },
        { key: 'screen_size_inch', label: 'Screen Size (inch)', placeholder: 'Inch', type: 'number' },
        { key: 'network', label: 'Connectivity', options: ['Wi-Fi Only', 'Wi-Fi + 4G', 'Wi-Fi + 5G'], type: 'select' },
