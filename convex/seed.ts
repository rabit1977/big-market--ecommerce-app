    ...
    template: {
      fields: [
        ...
        },
        {
          key: 'network',
          label: 'Connectivity',
          options: ['Wi-Fi Only', 'Wi-Fi + 4G', 'Wi-Fi + 5G'],
          type: 'select',
        },
        {
          key: 'color',
    ...
    template: {
      fields: [
        ...
        },
        {
          key: 'resolution',
          label: 'Resolution',
          options: ['1080p Full HD', '1440p 2K QHD', '4K Ultra HD', '5K', '8K'],
          type: 'select',
        },
        {
          key: 'panel_type',
        ...
        },
        {
          ...
          options: ['60', '75', '100', '120', '144', '165', '240', '360'],
          type: 'select',
        },
        {
          key: 'curved',
    ...
    template: {
      fields: [
        ...
        },
        {
          key: 'item_type',
          label: 'Type',
          options: ['Routers', 'Switches', 'Modems', 'Cables', 'Other'],
          type: 'select',
        },
        {
          key: 'brand',
