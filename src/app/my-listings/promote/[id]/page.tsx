    ...
    <div className='container max-w-3xl mx-auto py-8 px-4 pb-24'>
      <div className='mb-8'>
        ...
        <p className='text-muted-foreground text-lg leading-relaxed'>
          Promoting your listing increases its visibility by up to{' '}
          <span className='font-bold text-primary'>5x</span>. Get seen by more
          buyers, receive more inquiries, and sell faster. Choose the best
          promotion package for your needs below.
        </p>
      </div>
