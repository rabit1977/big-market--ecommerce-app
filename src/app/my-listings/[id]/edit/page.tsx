    ...
    return (
      <div className='container max-w-5xl mx-auto pt-20 text-center px-4'>
        <div className='bg-amber-500/10 border border-amber-500/20 rounded-[2rem] p-12 max-w-2xl mx-auto'>
          <h1 className='text-2xl font-black uppercase mb-4 text-amber-600'>
            Action Restricted
          </h1>
          <p className='font-bold text-muted-foreground mb-8'>
            You cannot edit this listing while it is waiting for administrator
            approval. Please wait until your listing is approved before making
            changes.
          </p>
          <a
            href='/my-listings'
            className='inline-flex h-12 items-center justify-center rounded-full bg-foreground px-8 text-sm font-black text-background uppercase tracking-wider transition-colors hover:bg-foreground/90'
          >
            Back to My Listings
          </a>
        </div>
