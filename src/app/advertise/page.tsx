...
export const metadata: Metadata = {
  title: 'Advertise | PazarPlus',
  description:
    "Reach thousands of active buyers daily. Discover powerful advertising solutions on PazarPluscedonia's leading classifieds platform.",
};
...
const WHY_US = [
  {
    icon: TrendingUp,
    text: 'Thousands of active listings across 20+ categories',
  },
    ...
    <div className='min-h-screen bg-background pb-24'>
        ...
        <div className='container-wide relative z-10'>
          <div className='max-w-3xl'>
            ...
            <p className='text-xl text-muted-foreground leading-relaxed max-w-2xl mb-8'>
              PazarPluss individuals and businesses the most powerful
              platform in Macedonia to showcase their listings. From featured
              placement to homepage spotlights — promote your listings with
              confidence.
            </p>
            <div className='flex flex-wrap gap-4'>
              <Button
                size='lg'
                asChild
                className='rounded-2xl font-bold btn-premium btn-glow'
              >
      ...
      <section className='container-wide pb-16'>
        ...
        <p className='text-muted-foreground mb-8 text-sm'>
          Choose the plan that fits your goal — or contact us for a fully custom
          arrangement.
        </p>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
          {AD_PACKAGES.map((pkg) => (
            ...
            >
              ...
              <div
                className={`w-12 h-12 rounded-xl ${pkg.bg} flex items-center justify-center`}
              >
        ...
        <div className='rounded-[2.5rem] bg-muted/40 border border-border/50 p-10 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8'>
          <div>
            ...
            <p className='text-muted-foreground max-w-lg'>
              Our team at <strong>PazarPlus</strong> is ready to help you
              find the right advertising solution. Reach out at{' '}
              <a
                href='mailto:support@PazarPlus.mk'
                className='text-primary font-bold hover:underline'
              >
                support@PazarPlus.mk
              </a>
              .
            </p>
          </div>
          <Button
            size='lg'
            asChild
            className='rounded-2xl font-bold btn-premium btn-glow shrink-0'
          >
