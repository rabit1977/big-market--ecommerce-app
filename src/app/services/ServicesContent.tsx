    ...
    <div className='min-h-screen py-20 space-y-24'>
      ...
      >
        ...
        <p className='text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed'>
          At PazarPlus, we are committed to providing the most secure and
          professional marketplace ecosystem in Macedonia. Discover the range of
          services designed to scale your sales.
        </p>
      </motion.section>
      ...
      >
        ...
        <div className='relative z-10 max-w-3xl mx-auto space-y-8'>
          ...
          <p className='text-xl text-primary-foreground/90 max-w-2xl mx-auto'>
            Our dedicated expert support team is here to help you with any
            questions or custom requirements you might have.
          </p>
