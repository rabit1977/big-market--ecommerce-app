        ...
        <div className='container-wide relative z-10'>
          ...
          >
            ...
            <h1 className='text-4xl md:text-6xl font-black tracking-tight text-foreground mb-6'>
              {isMk ? 'Прашања &' : 'Questions &'}{' '}
              <span className='text-primary'>
                {isMk ? 'Одговори' : 'Answers'}
              </span>
            </h1>
            <p className='text-lg text-muted-foreground leading-relaxed max-w-2xl'>
              {isMk
                ? 'Најдете одговори за најчестите прашања поврзани со управувањето на огласи, безбедноста и операциите со сметки на PazarPlus.'
                : 'Find answers to the most common inquiries regarding listing management, security, and account operations on PazarPlus.'}
            </p>
          </motion.div>
        </div>
              ...
              >
                <Card className='border-border/50 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5 transition-all overflow-hidden group'>
                  <CardHeader className='flex flex-row items-center gap-5 p-6 md:p-8'>
                    <div
                      className={`w-12 h-12 rounded-2xl ${faq.bgColor} flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform`}
                    >
            ...
            <div className='sticky top-24 space-y-6'>
              ...
              <Card className='border-border/50'>
                <CardHeader>
                  <CardTitle className='text-lg font-bold'>
                    {isMk ? 'Во оваа категорија' : 'In This Category'}
                  </CardTitle>
                </CardHeader>
              ...
              <div className='p-8 rounded-[2rem] bg-slate-900 shadow-xl shadow-slate-900/10 text-white relative overflow-hidden'>
                <div className='relative z-10 space-y-4'>
                  ...
                  <h3 className='text-xl font-black italic'>
                    {isMk ? 'Верификувани Профили.' : 'Verified Profiles.'}
                  </h3>
                  <p className='text-sm text-slate-400 leading-relaxed'>
                    {isMk
                      ? 'Верификуваните корисници добиваат приоритетна поддршка и поголеми квоти.'
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <Link href='/help/certification'>
                      {isMk ? 'Научи повеќе' : 'Learn About Certification'}
                    </Link>
                  </Button>
                </div>
              </div>
              ...
              <div className='bg-primary/5 rounded-[2rem] p-8 border border-primary/20 text-center'>
                ...
                <h4 className='font-black mb-2'>
                  {isMk ? 'Сè уште ви треба помош?' : 'Still need help?'}
                </h4>
                <p className='text-xs text-muted-foreground mb-6'>
                  {isMk
                    ? 'Не можете да го најдете тоа што го барате? Контактирајте го нашиот специјализиран тим.'
                ...
                >
                  <Link href='/contact'>
                    {isMk ? 'Испрати Порака' : 'Message Support'}
                  </Link>
                </Button>
              </div>
            </div>
