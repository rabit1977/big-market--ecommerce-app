        ...
        <div className='container-wide relative z-10'>
          ...
          >
            ...
            <h1 className='text-4xl md:text-6xl font-black tracking-tight text-foreground mb-6'>
              {isMk ? 'Центар за ' : 'Safety & '}{' '}
              <span className='text-primary'>
                {isMk ? 'Безбедност' : 'Security'}
              </span>{' '}
              {isMk ? ' и Сигурност' : ' Center'}
            </h1>
            <p className='text-lg text-muted-foreground leading-relaxed max-w-2xl'>
              {isMk
                ? 'На PazarPlus, вашата безбедност е наш основен приоритет. Дознајте како да ги заштитите вашите податоци, да тргувате со интегритет и да идентификувате сомнителна активност.'
                : 'At PazarPlusr security is our fundamental priority. Learn how to protect your data, trade with integrity, and identify suspicious activity.'}
            </p>
          </motion.div>
        </div>
          ...
          <div className='lg:col-span-8 space-y-16'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                <Card className='border-border/50 shadow-sm hover:border-primary/30 transition-colors'>
                  <CardHeader className='pb-2'>
                    ...
                    <CardTitle className='text-lg'>
                      {isMk ? 'Верификација во живо' : 'In-Person Verification'}
                    </CardTitle>
                  </CardHeader>
                  <CardContent className='text-sm text-muted-foreground'>
                    {isMk
                      ? 'Секогаш кога е можно, проверете го предметот лично пред да ја завршите трансакцијата. Секогаш среќавајте се на добро осветлени, јавни локации за време на дневните часови.'
                ...
                <Card className='border-border/50 shadow-sm hover:border-primary/30 transition-colors'>
                  <CardHeader className='pb-2'>
                    ...
                    <CardTitle className='text-lg'>
                      {isMk ? 'Безбедна Комуникација' : 'Secure Communication'}
                    </CardTitle>
                  </CardHeader>
                  <CardContent className='text-sm text-muted-foreground'>
                    {isMk
                      ? 'Користете го наменскиот систем за пораки на PazarPlusрвичен контакт. Измамниците често се обидуваат да ги пренесат разговорите на други платформи како WhatsApp рано во комуникацијата.'
                      : 'Utilize PazarPlusternal messaging system for initial contact. Fraudsters often attempt to move conversations to unmonitored platforms like WhatsApp early on.'}
                  </CardContent>
                </Card>
              </div>
            </section>
            ...
            <section id='scams' className='scroll-mt-24'>
              <div className='flex items-center gap-4 mb-8'>
                ...
                <h2 className='text-3xl font-black tracking-tight flex flex-col gap-1'>
                  {isMk
                    ? 'Избегнување на вообичаени измами'
              ...
              <div className='space-y-6'>
                <div className='p-8 rounded-[2rem] border border-red-500/20 bg-red-500/5'>
                  <h4 className='font-black text-red-700 dark:text-red-400 mb-6 flex items-center gap-2 flex-wrap'>
                    ...
                    {isMk
                      ? 'Фишинг и надворешни линкови'
                      : 'Phishing & External Links'}
                  </h4>
                  <p className='text-sm text-muted-foreground leading-relaxed mb-6'>
                    {isMk
                      ? 'Бидете исклучително внимателни за линкови испратени преку СМС или апликации за пораки кои тврдат дека се од PazarPlusarPazarPlusема да ги побара вашите податоци за картичка преку надворешен линк.'
                      : 'Be extremely cautious of links sent via SMS or messaging apps claiming to be from PazarPlus"Payment Verification" or "Shipping Labels". PazarPazarPlusver** ask for your credit card details via a third-party link.'}
                  </p>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <div className='flex items-start gap-3 p-4 bg-background rounded-2xl border border-red-500/10'>
                      ...
                      <div className='space-y-1'>
                        <h5 className='text-sm font-bold'>
                          {isMk ? 'Лажен купувач' : 'Fake Buyer Scam'}
                        </h5>
                        <p className='text-xs text-muted-foreground italic'>
                          "
                          {isMk
                            ? 'Ќе платам преку линк за курир...'
                            : "I'll pay via courier link..."}
                          "
                        </p>
                      </div>
                    </div>
                    <div className='flex items-start gap-3 p-4 bg-background rounded-2xl border border-red-500/10'>
                      ...
                      <div className='space-y-1'>
                        <h5 className='text-sm font-bold'>
                          {isMk ? 'Преплатување' : 'Overpayment Scam'}
                        </h5>
                        <p className='text-xs text-muted-foreground italic'>
                          "
                          {isMk
                            ? 'Случајно испратив повеќе пари...'
                            : 'I accidentally sent extra money...'}
                          "
                        </p>
                      </div>
                    </div>
                  ...
                  <div className='flex gap-6'>
                    ...
                    <div className='space-y-2'>
                      <h4 className='font-bold'>
                        {isMk
                          ? 'Користете го копчето "Пријави"'
                          : 'Use the "Report" Button'}
                      </h4>
                      <p className='text-sm text-muted-foreground'>
                        {isMk
                          ? 'Секој оглас има посебно знаменце за пријавување. Користете го ова за неточни категории, забранети предмети или сомнителни цени.'
                          : 'Every listing has a dedicated report flag. Use this for incorrect categories, prohibited items, or suspicious pricing.'}
                      </p>
                    </div>
                  </div>
                  <div className='flex gap-6'>
                    ...
                    <div className='space-y-2'>
                      <h4 className='font-bold'>
                        {isMk
                          ? 'Контактирајте нè Директно'
                          : 'Contact Security Directly'}
                      </h4>
                      <p className='text-sm text-muted-foreground'>
                        {isMk
                          ? 'За итни безбедносни прекршувања или кражба на сметка, испратете е-пошта до нашиот тим за одговор на abuse@PazarPlus.com.'
                          : 'For urgent security breaches or account theft, email our dedicated response team at abuse@PazarPlus.com.'}
                      </p>
                    </div>
                  </div>
                  <div className='flex gap-6'>
                    ...
                    <div className='space-y-2'>
                      <h4 className='font-bold'>
                        {isMk ? 'Зачувајте Докази' : 'Preserve Evidence'}
                      </h4>
                      <p className='text-sm text-muted-foreground'>
                        {isMk
                          ? 'Направете слики од екранот од разговорите или наведените ставки пред да пријавите, бидејќи тоа им помага на нашите специјалисти во брзата верификација.'
                          : 'Take screenshots of conversations or listed items before reporting, as this assists our specialists in rapid verification.'}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className='sticky top-24 space-y-8'>
              ...
              <div className='p-8 rounded-[2.5rem] bg-slate-900 text-white relative overflow-hidden'>
                ...
                <h3 className='text-2xl font-black mb-4'>
                  {isMk ? 'Стандард за Доверба' : 'The Trust Standard'}
                </h3>
                <p className='text-sm text-slate-400 leading-relaxed mb-8'>
                  {isMk
                    ? 'Побарајте ја Значката за верификација на корисничките профили. Ова покажува дека корисникот поминал преку верификација и одржува професионална историја на PazarPlus.'
                    : 'Look for the **Verified Badge** on user profiles. This indicates the user has undergone identity verification and maintains a professional history on PazarPlus.'}
                </p>
                <Button
                ...
                >
                  <Link href='/account/verification'>
                    {isMk ? 'Верифицирајте се' : 'Get Verified'}
                  </Link>
                </Button>
              ...
              <Card className='border-emerald-500/20 shadow-lg shadow-emerald-500/5 hover:border-emerald-500/40 transition-colors'>
                <CardHeader>
                  <CardTitle className='text-lg flex flex-col gap-1 text-emerald-600'>
                    <div className='flex items-center gap-2'>
                      ...
                      {isMk ? 'Безбедни плаќања' : 'Safe Payments'}
                    </div>
                  </CardTitle>
                </CardHeader>
                <CardContent className='space-y-4'>
                  <p className='text-sm text-muted-foreground'>
                    {isMk
                      ? 'PazarPlusорачува плаќање при достава или банкарски трансфери во живо откако ќе го разгледате предметот.'
                      : 'PazarPlusmmends cash-on-delivery or in-person bank transfers only after item inspection.'}
                  </p>
                  ...
                  <div className='space-y-2'>
                    <div className='flex items-center gap-2 text-xs font-bold text-emerald-700'>
                      ...
                      <span>
                        {isMk
                          ? 'Избегнувајте депозити однапред'
                    ...
                    <div className='flex items-center gap-2 text-xs font-bold text-emerald-700'>
                      ...
                      <span>
                        {isMk
                          ? 'Игнорирајте барања преку Western Union'
              ...
              <div className='bg-muted/50 rounded-3xl p-8 border border-border/50'>
                ...
                <p className='text-xs text-muted-foreground mb-6 leading-relaxed'>
                  {isMk
                    ? 'Ако чувствувате дека сте биле жртва на кривично дело, ве молиме веднаш контактирајте го вашиот локален полициски оддел.'
