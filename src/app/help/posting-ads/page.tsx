        ...
        <div className='container-wide relative z-10'>
          ...
          >
            ...
            <h1 className='text-4xl md:text-6xl font-black tracking-tight text-foreground mb-6'>
              {isMk ? 'Објавување и ' : 'Posting & '}{' '}
              <span className='text-primary'>
                {isMk ? 'Управување ' : 'Managing '}
              </span>{' '}
              {isMk ? 'со огласи' : 'Ads'}
            </h1>
            <p className='text-lg text-muted-foreground leading-relaxed max-w-2xl'>
              {isMk
                ...
                : 'Everything you need to know about creating professional listings, reaching more buyers, and managing your shop on PazarPlus.'}
            </p>
          </motion.div>
        </div>
                ...
                <Card className='border-border/50 shadow-sm overflow-hidden hover:border-primary/30 transition-colors'>
                  <CardHeader className='bg-muted/30 border-b border-border/50'>
                    <CardTitle className='text-xl'>
                      {isMk ? 'Стратегија за содржина' : 'Content Strategy'}
                    </CardTitle>
                  </CardHeader>
                  <CardContent className='p-8 space-y-6'>
                    <div className='flex gap-6 items-start'>
                      ...
                      <div className='space-y-2'>
                        <h4 className='font-bold'>
                          {isMk ? 'Ефективни наслови' : 'Effective Titles'}
                        </h4>
                        <p className='text-sm text-muted-foreground leading-relaxed'>
                          {isMk
                            ? 'Користете јасни, концизни наслови кои прецизно го опишуваат предметот. Вклучете го брендот, моделот и клучната состојба.'
                    ...
                    <div className='flex gap-6 items-start'>
                      ...
                      <div className='space-y-2'>
                        <h4 className='font-bold'>
                          {isMk ? 'Детални описи' : 'Detailed Descriptions'}
                        </h4>
                        <p className='text-sm text-muted-foreground leading-relaxed'>
                          {isMk
                            ? 'Транспарентноста гради доверба. Наведете технички спецификации, историја на користење и какви било постоечки дефекти.'
                    ...
                    <div className='flex gap-6 items-start'>
                      ...
                      <div className='space-y-2'>
                        <h4 className='font-bold'>
                          {isMk ? 'Визуелна извонредност' : 'Visual Excellence'}
                        </h4>
                        <p className='text-sm text-muted-foreground leading-relaxed'>
                          {isMk
                            ? 'Фотографијата со висока резолуција е задолжителна. Примарната слика мора да биде од вистинскиот предмет.'
              ...
              <div className='bg-card border border-border/50 rounded-[2rem] p-8 md:p-12 shadow-sm'>
                <div className='max-w-xl space-y-6'>
                  <p className='text-muted-foreground leading-relaxed'>
                    {isMk
                      ? 'Управувањето со вашиот инвентар на PazarPlusционализирано преку вашата професионална контролна табла. Одржувањето на вашите огласи ажурирани обезбедува подобро искуство за купувачите и повисоко рангирање за вас.'
                      : 'Managing your inventory on PazarPazarPluslined through your professional dashboard. Keeping your listings current ensures a better experience for buyers and higher rankings for you.'}
                  </p>
                  ...
                  <div className='space-y-4'>
                    <div className='flex items-center gap-4 p-4 rounded-2xl bg-muted/50 border border-border/50 group hover:border-primary/30 transition-all flex-col sm:flex-row sm:items-center items-start text-left'>
                      ...
                      <span className='font-bold text-sm'>
                        {isMk
                          ? 'Ажурирања на статусот во реално време (Продадено, Резервирано, Активно)'
                          : 'Real-time status updates (Sold, Reserved, Active)'}
                      </span>
                    </div>
                    <div className='flex items-center gap-4 p-4 rounded-2xl bg-muted/50 border border-border/50 group hover:border-primary/30 transition-all flex-col sm:flex-row sm:items-center items-start text-left'>
                      <CheckCircle2 className='w-5 h-5 text-primary shrink-0' />
                      <span className='font-bold text-sm'>
                        {isMk
                          ? 'Инстантно уредување на цените и спецификациите'
                          : 'Instant editing of pricing and specifications'}
                      </span>
                    </div>
                    <div className='flex items-center gap-4 p-4 rounded-2xl bg-muted/50 border border-border/50 group hover:border-primary/30 transition-all flex-col sm:flex-row sm:items-center items-start text-left'>
                      <CheckCircle2 className='w-5 h-5 text-primary shrink-0' />
                      <span className='font-bold text-sm'>
                        {isMk
                          ? 'Автоматски предупредувања за истекување преку е-пошта'
                          : 'Automatic expiration alerts via email'}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className='pt-6'>
                    <Button className='rounded-full px-8 font-bold' asChild>
                      <Link href='/my-listings'>
                        {isMk ? 'Одете во Мои огласи' : 'Go to My Listings'}
                      </Link>
                    </Button>
                  </div>
                </div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                <Card className='border-primary/20 bg-primary/5 hover:border-primary/40 transition-colors'>
                  ...
                  <CardContent className='text-sm text-muted-foreground leading-relaxed'>
                    {isMk
                      ? 'Промовираните огласи добиваат до 10 пати повеќе прегледи. Изберете од поставување на почетната страница, врвно позиционирање или истакнување во категорија.'
                ...
                <Card className='border-blue-500/20 bg-blue-500/5 hover:border-blue-500/40 transition-colors'>
                  ...
                  <CardContent className='text-sm text-muted-foreground leading-relaxed'>
                    {isMk
                      ? 'Верификуваните корисници и деловните сметки добиваат приоритет во резултатите од пребарувањето.'
            ...
            <div className='sticky top-24 space-y-6'>
              ...
              <Card className='border-red-500/20 shadow-lg shadow-red-500/5'>
                <CardHeader>
                  <CardTitle className='text-lg flex flex-col gap-1 text-red-600'>
                    <div className='flex items-center gap-2'>
                      ...
                      {isMk ? 'Правила за фер игра' : 'Fair Play Rules'}
                    </div>
                  </CardTitle>
                </CardHeader>
                <CardContent className='space-y-4'>
                  <p className='text-sm text-muted-foreground'>
                    {isMk
                      ? 'За одржување на професионална средина, многу предмети и практики се ограничени.'
                  ...
                  <ul className='text-xs space-y-2 font-bold text-muted-foreground'>
                    <li className='flex gap-2'>
                      ...
                      <span>
                        {isMk ? 'Без дупликат огласи' : 'No duplicate listings'}
                      </span>
                    </li>
                    <li className='flex gap-2'>
                      <ArrowRight className='w-3 h-3 text-red-500 shrink-0 mt-0.5' />
                  ...
                  <Button
                    variant='outline'
                    className='w-full text-xs font-bold border-red-200 hover:bg-red-50 rounded-xl'
                    asChild
                  >
                    <Link href='/help/terms#prohibited'>
                      {isMk ? 'Види ги сите правила' : 'View All Rules'}
                    </Link>
                  </Button>
                </CardContent>
              </Card>
              ...
              <div className='p-8 rounded-[2rem] bg-slate-900 text-white relative overflow-hidden'>
                <div className='relative z-10 space-y-4'>
                  <h3 className='text-xl font-black italic'>
                    {isMk ? 'Сертифицирајте се.' : 'Get Certified.'}
                  </h3>
                  <p className='text-sm text-slate-400 leading-relaxed'>
                    {isMk
                      ? 'Потребна е верификација за да управувате со вашите огласи. Изградете доверба во заедницата денес.'
                      : 'Verification is required for listing management. Establish trust within the PazarPlusunity today.'}
                  </p>
                  <Button
                    variant='secondary'
                  ...
                  >
                    <Link href='/account/verification'>
                      {isMk ? 'Аплицирајте сега' : 'Apply Now'}
                    </Link>
                  </Button>
                </div>
              ...
              <div className='bg-muted/50 rounded-[2rem] p-8 border border-border/50 text-center'>
                ...
                <h4 className='font-black mb-2'>
                  {isMk ? 'Ви треба помош?' : 'Still need help?'}
                </h4>
                <p className='text-xs text-muted-foreground mb-6'>
                  {isMk
                    ? 'Нашите специјалисти можат да ви помогнат.'
