...
const CATEGORY_IMAGES: Record<string, string> = {
  ...
  'commercial-property':
    'https://cdn.pixabay.com/photo/2014/11/11/22/50/architecture-527633_1280.jpg',
  'home-and-garden':
    'https://cdn.pixabay.com/photo/2017/08/27/10/16/interior-2685521_1280.jpg',
  'home-appliances':
    'https://cdn.pixabay.com/photo/2015/12/03/17/19/washing-machine-1075253_1280.jpg',
  ...
  'trucks-vans':
    'https://cdn.pixabay.com/photo/2015/09/25/11/12/truck-957173_1280.jpg',
  ...
  tablets:
    'https://cdn.pixabay.com/photo/2014/08/05/10/27/iphone-410311_1280.jpg',
  'tvs-audio':
    'https://cdn.pixabay.com/photo/2017/04/24/09/35/sound-2255760_1280.jpg',
  'tv-audio-video':
    'https://cdn.pixabay.com/photo/2017/04/24/09/35/sound-2255760_1280.jpg',
  ...
  'fashion-clothing':
    'https://cdn.pixabay.com/photo/2016/11/22/19/08/hangers-1850082_1280.jpg',
  'mens-clothing':
    'https://cdn.pixabay.com/photo/2015/09/02/13/24/man-919045_1280.jpg',
  'womens-clothing':
  ...
  accessories:
    'https://cdn.pixabay.com/photo/2015/08/25/11/58/sunglasses-906532_1280.jpg',
  'watches-jewelry':
    'https://cdn.pixabay.com/photo/2017/01/12/17/30/warm-shades-1975214_1280.jpg',
  jewelry:
    'https://cdn.pixabay.com/photo/2017/01/12/17/30/warm-shades-1975214_1280.jpg',
  'health-beauty':
  ...
  // 5. Sports & Hobbies
  'sports-leisure':
    'https://cdn.pixabay.com/photo/2014/06/11/17/00/basketball-366925_1280.jpg',
  'sports-hobbies':
    'https://cdn.pixabay.com/photo/2014/06/11/17/00/basketball-366925_1280.jpg',
  bicycles:
    'https://cdn.pixabay.com/photo/2016/11/18/12/46/bicycle-1834265_1280.jpg',
  'gym-fitness':
  ...
  'jobs-services':
    'https://cdn.pixabay.com/photo/2018/02/16/11/24/office-3157521_1280.jpg',
  education:
  ...
  'office-school-supplies':
    'https://cdn.pixabay.com/photo/2015/01/08/18/25/desk-593327_1280.jpg',
  'do-it-yourself':
    'https://cdn.pixabay.com/photo/2017/08/10/05/18/tools-2618053_1280.jpg',
  'cordless-tools':
    'https://cdn.pixabay.com/photo/2017/08/10/05/18/tools-2618053_1280.jpg',

  // 8. Other
  'food-agriculture':
    'https://cdn.pixabay.com/photo/2017/05/19/22/41/gardening-2327666_1280.jpg',
  'fresh-produce':
    'https://cdn.pixabay.com/photo/2017/05/19/22/41/gardening-2327666_1280.jpg',
  'business-equipment':
    'https://cdn.pixabay.com/photo/2014/11/11/22/50/architecture-527633_1280.jpg',
  'baby-children':
    'https://cdn.pixabay.com/photo/2016/11/29/11/32/baby-1869213_1280.jpg',

  // 9. Services & Other
  services:
    'https://cdn.pixabay.com/photo/2015/12/08/10/37/hands-1082596_1280.jpg',
  'home-services':
    'https://cdn.pixabay.com/photo/2016/08/26/15/06/home-1622401_1280.jpg',
  'business-services':
    'https://cdn.pixabay.com/photo/2018/02/16/10/52/industry-3157431_1280.jpg',
  'personal-services':
  ...
  'garden-outdoor':
    'https://cdn.pixabay.com/photo/2017/05/19/22/41/gardening-2327666_1280.jpg',
  'sports-equipment':
    'https://cdn.pixabay.com/photo/2014/04/17/23/26/tennis-326523_1280.jpg',
  'pet-accessories':
...
export default async function CategoriesPage() {
  ...
  return (
    <div className='min-h-screen bg-background dark:bg-background mb-10'>
      {/* Hero Section */}
          ...
          {categories.map((category, index) => {
            ...
            return (
              <Link
                ...
                className='group relative flex flex-col rounded-2xl overflow-hidden hover:shadow-xl hover:border-primary/40 transition-all duration-300 aspect-square sm:aspect-[4/3] bg-muted shadow-sm border border-border/30 flex-shrink-0 max-h-23 sm:max-h-33 min-w-38 sm:min-w-48 max-w-48 mx-auto'
              >
                ...
                <div className='relative z-10 flex flex-col items-center justify-center p-4 w-full h-full text-center'>
                  <h3 className='font-bold text-xs sm:text-base leading-tight text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] transition-transform group-hover:scale-110 duration-500'>
                    {category.name}
                  </h3>
                </div>
              </Link>
