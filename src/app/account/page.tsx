              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  <Link href="/account/password" className="group">
                    <div className="bg-card p-5 sm:p-6 rounded-2xl transition-all flex items-center gap-4 bm-interactive shadow-none">
                       ...
                       <div className='min-w-0'>
                          <p className="font-black text-foreground text-xs sm:text-sm uppercase tracking-widest truncate">Security</p>
                          <p className="text-[10px] sm:text-xs text-muted-foreground font-bold truncate">Update password</p>
                       </div>
                    </div>
                 </Link>
                 <Link href="/account/verification" className="group">
                    <div className="bg-card p-5 sm:p-6 rounded-2xl transition-all flex items-center gap-4 bm-interactive shadow-none">
                       ...
                       <div className='min-w-0'>
                          <p className="font-black text-foreground text-xs sm:text-sm uppercase tracking-widest truncate">Verification</p>
                          <p className="text-[10px] sm:text-xs text-muted-foreground font-bold truncate">Identity check</p>
                       </div>
                    </div>
                 </Link>
              </div>
              ...
              {/* Quick Navigation Card */}
               <div className='bg-card rounded-2xl md:rounded-2xl overflow-hidden bm-interactive shadow-none'>
                  <div className='px-4 sm:px-6 py-4 border-b border-border/50 bg-muted/30'>
                    <h3 className='text-[10px] sm:text-xs font-black uppercase tracking-[0.2em] text-muted-foreground'>Quick Navigation</h3>
                  </div>
