  ...
  return (
    <div className='space-y-6 sm:space-y-8 pb-20'>
      ...
      <Tabs defaultValue="support" className="w-full space-y-6">
        <TabsList className="grid w-full grid-cols-4 max-w-[800px] bg-secondary rounded-lg">
        ...
        <TabsContent value="support" className="space-y-4">
            <div className="rounded-lg border border-border bg-card p-4 md:p-6 shadow-none">
                <div className="mb-4">
            ...
            <div className="rounded-lg border border-border bg-card p-4 md:p-6 shadow-none">
                 <div className="mb-4 flex items-center gap-2">
                    <h2 className="text-lg font-bold flex items-center gap-2">
                        ...
                        Product Questions
                        <span className='inline-flex items-center justify-center px-2 py-0.5 rounded-lg bg-primary/10 text-primary text-xs font-bold ring-1 ring-inset ring-primary/20'>
                            {total || 0}
                        </span>
                    </h2>
                 </div>
