...
export async function generateMetadata() {
  ...
  return {
    title: isMk ? 'Админ - Промовирани Огласи' : 'Admin - Promoted Listings',
  };
}
      ...
      <div className="flex flex-col gap-2">
        <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 items-center justify-between">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <h1 className="text-3xl font-bold tracking-tight">
                {isMk ? 'Промовирани Огласи' : 'Promoted Listings'}
              </h1>
            </div>
            <p className="text-muted-foreground">
              {isMk 
                ? 'Прегледај и мониторирај ги сите моментално промовирани/истакнати огласи.' 
          ...
          <div className="flex items-center gap-3">
            ...
            >
              {isMk ? 'Види Ги Сите Огласи →' : 'View All Listings →'}
            </Link>
          </div>
        </div>
      </div>
