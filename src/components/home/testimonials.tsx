...
export const Testimonials = () => {
  ...
  // Reset interval whenever `next` changes (i.e. on manual navigation too)
  useEffect(() => {
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto">
          <div className="flex flex-col items-center text-center space-y-6">
              ...
              >
                ...
                <div className="flex flex-col items-center gap-3">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <div className="flex items-center justify-center gap-0.5" aria-label={`${activeTestimonial.rating ?? 5} out of 5 stars`}>
            ...
            <div className="flex justify-center gap-2 pt-4" role="tablist" aria-label="Testimonials navigation">
