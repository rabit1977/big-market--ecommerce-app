      ...
      <div className='container-wide px-3 md:px-4'>
        ...
        <div className='max-w-2xl mx-auto text-center mb-8 md:mb-14'>
          ...
          <p className='text-sm md:text-base text-muted-foreground max-w-lg mx-auto'>
            Over 2 million people browse PazarPlus every month. A premium
            membership puts your products in front of all of them.
          </p>
        </div>
        ...
        <div className='mt-12 md:mt-16 max-w-4xl mx-auto'>
          <div className='text-center mb-6 md:mb-8'>
            ...
            <p className='text-xs md:text-sm text-muted-foreground'>
              One-time add-ons to give any listing extra visibility — no
              membership required
            </p>
          </div>
              ...
              >
                <div className='flex items-start gap-3 mb-3'>
                  ...
                  <div className='min-w-0'>
                    ...
                    <p className='text-[10px] md:text-xs text-muted-foreground leading-relaxed mt-0.5'>
                      {addon.description}
                    </p>
                  </div>
                </div>
