...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-(--bm-button-border-radius) text-sm font-medium transition-all duration-150 ease-in-out disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:border-primary/50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-1 border-card-foreground/20 bg-background hover:bg-accent hover:border-card-foreground/50 transition-all duration-200",
        secondary:
      ...
      size: {
        default: "h-9 px-4 py-[10px] has-[>svg]:px-4",
